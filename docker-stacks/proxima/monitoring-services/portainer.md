...
```
mkdir -p /srv/docker/appdata/portainer/{data,config}
mkdir -p /srv/docker/stacks/portainer
sudo chown -R 1000:1000 /srv/docker/appdata/portainer
chmod -R 750 /srv/docker/appdata/portainer

sudo chown -R $USER:$USER /srv/docker/stacks/portainer
chmod -R 755 /srv/docker/stacks/portainer

cd /srv/docker/stacks/portainer
```
